...
public class Percolation{
    ...
    public static byte[] topLst=null;
    public static byte printConnected=0;
    ...
    //union that!
        for (int i =1; i<serialmatrixSize;i++){
            ...
            if(((i/matixSize)==matixSize)|((i/matixSize)==(matixSize-1))){
                if(test.find(i)<=matixSize){
                    printConnected=0;
                }else{
                    printConnected=-1;
                }
    ...
    */
    ...
    public static void creatTopLst(){
    ...
    public static String serialToMatrix(int serialNum){
        ...
        if (x==0){                   //avoid %=0 exception, it is a annoyed bug
            x = matixSize;
            y -= 1;
        }
