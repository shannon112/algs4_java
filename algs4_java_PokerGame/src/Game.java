...
public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
                ...
                //2.Get Community cards, get 5 cards
                ...
                //3.Set player's cards, get each one 2 cards
                for(String in = br.readLine(); in != null; in = br.readLine()) {
                        ...
                        player.setCards(cardsArray); //input this card set to player object
                }

                //4.Sorting and get the winner
                Arrays.sort(playerArray);// winner is at the lager index
